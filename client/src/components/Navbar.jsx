...
const Navbar = () => {
    ...
    return (
        <nav className="flex flex-wrap items-center justify-between gap-y-2 px-4 sm:px-6 md:px-12 py-3 mx-4 md:mx-16 lg:mx-24 mt-4 mb-2 bg-white/70 backdrop-blur-md border border-white/50 shadow-sm rounded-full relative z-50 transition-all">
